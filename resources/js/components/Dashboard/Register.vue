<template>
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Email" v-model="form.name" id="name" required>
    ...
    <input type="password" placeholder="Repeat Password" v-model="form.password_confirmation" id="password_confirmation" required>
    <hr>

    <p>By creating an account you agree to our <a href="#">Terms & Privacy</a>.</p>
    <button @click.prevent="saveForm" type="submit" class="registerbtn">Register</button>
  </div>
