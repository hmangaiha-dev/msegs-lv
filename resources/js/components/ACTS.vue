<template>
  <div style="margin-top:auto">
    <div class="ourservices">
      <p class="headings " style="margin:auto">Acts & Rules</p>
    </div>
    ...
    data() {
        return {
            resources: [
              ...
              {title:'Memorandum of Association',path:'https://drive.google.com/file/d/1-sRrqRwtN1FnxlLCZAnSrO_rkAExUFZV/view?usp=sharing'},
