        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
            <div class="flex items-center justify-center mt-8">
                <div class="flex items-center">
                    ...
                    FIRE & EMERGENCY SERVICES Dashboard</span>
                </div>
            </div>
            ...
            <nav class="mt-10">
                <a class="flex items-center mt-4 py-2 px-6 bg-gray-700 bg-opacity-25 text-gray-100" href="/">
                    ...
                    <span class="mx-3">Forms Submitted</span>
                </a>
                ...
                <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                    ...
                    <span class="mx-3">Approved Forms</span>
                </a>
                ...
                <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
                    ...
                    <span class="mx-3">Rejected forms</span>
                </a>
                            ...
                            <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                    ...
                                    <div class="mx-5">
                                        ...
                                        <div class="text-gray-500">Forms Received</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">Form2</div>
                                                <div class="text-sm leading-5 text-gray-500">Land</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">Form1</div>
                                                <div class="text-sm leading-5 text-gray-500">Land</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">Form 1</div>
                                                <div class="text-sm leading-5 text-gray-500">Land</div>
                                            </td>
